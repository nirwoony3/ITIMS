					...
					a.jqx._jqxFileUpload.prototype,
					{
						defineInstance : function() {
							var b = {
								...
								disabled : false,
								rtl : false,
								events : [ "select", "remove", "uploadStart",
										"uploadEnd" ]
							};
						...
						createInstance : function() {
							...
							if (b.host.jqxButton === undefined) {
								throw new Error(
										"jqxFileUpload: Missing reference to jqxbuttons.js")
							}
							...
							b._fluidWidth = typeof b.width === "string"
									&& b.width.charAt(b.width.length - 1) === "%";
							b._fluidHeight = typeof b.height === "string"
									&& b.height.charAt(b.height.length - 1) === "%";
							b._render(true)
						},
						...
						browse : function() {
							...
							var b = this;
							if (b.multipleFilesUpload === true
									|| (b.multipleFilesUpload === false && b._fileRows.length === 0)) {
						...
						propertyChangedHandler : function(f, n, c, m) {
							...
							if (n === "localization") {
								if (m.browseButton
										&& (!c || m.browseButton !== c.browseButton)) {
								...
								if (m.uploadButton
										&& (!c || m.uploadButton !== c.uploadButton)) {
								...
								if (m.cancelButton
										&& (!c || m.cancelButton !== c.cancelButton)) {
								...
								if (!f.renderFiles) {
									if (m.uploadFileTooltip
											&& (!c || m.uploadFileTooltip !== c.uploadFileTooltip)) {
										a(
												"#"
														+ b
									...
									if (m.uploadFileTooltip
											&& (!c || m.cancelFileTooltip !== c.cancelFileTooltip)) {
										a(
												"#"
														+ b
							...
							if (m !== c) {
								...
								case "height":
									...
									f._fluidHeight = typeof m === "string"
											&& m.charAt(m - 1) === "%";
									return;
								case "uploadUrl":
								...
								case "rtl":
									var k = function(l) {
										...
										f._browseButton[p]
												(f
														.toThemeProperty("jqx-file-upload-button-browse-rtl"));
										f._cancelButton[p]
												(f
														.toThemeProperty("jqx-file-upload-button-cancel-rtl"));
										f._uploadButton[p]
												(f
														.toThemeProperty("jqx-file-upload-button-upload-rtl"));
										if (a.jqx.browser.msie
												&& a.jqx.browser.version > 8) {
											f._uploadButton[p]
													(f
															.toThemeProperty("jqx-file-upload-button-upload-rtl-ie"))
										}
										for (var i = 0; i < f._fileRows.length; i++) {
											var j = f._fileRows[i];
											j.fileNameContainer[p]
													(f
															.toThemeProperty("jqx-file-upload-file-name-rtl"));
											j.cancelFile[p]
													(f
															.toThemeProperty("jqx-file-upload-file-cancel-rtl"));
											j.uploadFile[p]
													(f
															.toThemeProperty("jqx-file-upload-file-upload-rtl"));
											j.loadingElement[p]
													(f
															.toThemeProperty("jqx-file-upload-loading-element-rtl"))
										}
									};
									k(m);
									return
						...
						_borderAndPadding : function(e, c) {
							var b;
							if (e === "width") {
								b = parseInt(c.css("border-left-width"), 10)
										+ parseInt(c.css("border-right-width"),
												10)
										+ parseInt(c.css("padding-left"), 10)
										+ parseInt(c.css("padding-right"), 10)
							} else {
								b = parseInt(c.css("border-top-width"), 10)
										+ parseInt(
												c.css("border-bottom-width"),
												10)
						...
						_addClasses : function() {
							...
							b.host
									.addClass(b
											.toThemeProperty("jqx-widget jqx-widget-content jqx-rc-all jqx-file-upload"));
							if (b.disabled === true) {
								b.host
										.addClass(b
												.toThemeProperty("jqx-fill-state-disabled"))
						...
						_appendElements : function() {
							var h = this, c = "Browse", b = 90, i = "Upload All", f = 90, e = "Cancel All", g = 90;
							var j = h.element.id;
							if (h.localization) {
							...
							h._browseButton = a('<button id="'
									+ j
									+ 'BrowseButton" class="'
									+ h
											.toThemeProperty("jqx-file-upload-button-browse")
									+ '">' + c + "</button>");
							...
							h._bottomButtonsContainer = a('<div class="'
									+ h
											.toThemeProperty("jqx-file-upload-buttons-container")
									+ '"></div>');
							h.host.append(h._bottomButtonsContainer);
							h._uploadButton = a('<button id="'
									+ j
									+ 'UploadButton" class="'
									+ h
											.toThemeProperty("jqx-file-upload-button-upload")
									+ '">' + i + "</button>");
							...
							h._cancelButton = a('<button id="'
									+ j
									+ 'CancelButton" class="'
									+ h
											.toThemeProperty("jqx-file-upload-button-cancel")
									+ '">' + e + "</button>");
							...
							h._uploadIframe = a('<iframe name="'
									+ j
									+ 'Iframe" class="'
									+ h
											.toThemeProperty("jqx-file-upload-iframe")
									+ '" src=""></iframe>');
						...
						_addFormAndFileInput : function() {
							...
							var j = g.element.id;
							var f = a('<form class="'
									+ g.toThemeProperty("jqx-file-upload-form")
									+ '" action="'
									+ g.uploadUrl
									+ '" target="'
									+ j
									+ 'Iframe" method="post" enctype="multipart/form-data"></form>');
							g.host.append(f);
							var e = a('<input type="file" class="'
									+ g
											.toThemeProperty("jqx-file-upload-file-input")
									+ '" />');
							if (g.accept) {
							...
							if (g._ieOldWebkit) {
								...
								f
										.addClass(g
												.toThemeProperty("jqx-file-upload-form-ie9"));
								e
										.addClass(g
												.toThemeProperty("jqx-file-upload-file-input-ie9"));
								g
										.addHandler(
												f,
												"mouseenter.jqxFileUpload" + j,
												function() {
													g._browseButton
															.addClass(g
								...
								g
										.addHandler(
												a(document),
												"mouseup.jqxFileUpload" + j,
												function() {
													if (g._browseButton
															.hasClass("jqx-fill-state-pressed")) {
														g._browseButton
																.removeClass(g
																		.toThemeProperty("jqx-fill-state-pressed"))
													}
							...
							g
									.addHandler(
											...
											function() {
												...
												if (g._ieOldWebkit) {
													g.removeHandler(f,
															"mouseenter.jqxFileUpload"
																	+ j);
													g.removeHandler(f,
															"mouseleave.jqxFileUpload"
																	+ j);
													g.removeHandler(f,
															"mousedown.jqxFileUpload"
																	+ j)
												}
												g._addFormAndFileInput();
												g.removeHandler(e,
														"change.jqxFileUpload"
																+ j);
							...
							if (g._ieOldWebkit === true) {
								g.addHandler(e, "click.jqxFileUpload" + j,
										function(k) {
											if (g.multipleFilesUpload === false
													&& g._fileRows.length > 0) {
												k.preventDefault()
											}
										})
							}
						...
						_addFileRow : function(g, b, f, e) {
							var i = this, m, h, n, k, o, j = "Cancel", l = "Upload File";
							m = a('<div class="'
									+ i
											.toThemeProperty("jqx-widget-content jqx-rc-all jqx-file-upload-file-row")
									+ '"></div>');
							if (i._fileRows.length === 0) {
								i._browseButton.after(m)
							} else {
								i._fileRows[i._fileRows.length - 1].fileRow
										.after(m)
							}
							if (!i.renderFiles) {
								h = a('<div class="'
										+ i
												.toThemeProperty("jqx-widget-header jqx-rc-all jqx-file-upload-file-name")
										+ '">' + g + "</div>");
								m.append(h);
								if (i.localization) {
								...
								k = a('<div class="'
										+ i
												.toThemeProperty("jqx-widget-header jqx-rc-all jqx-file-upload-file-cancel")
										+ '" title="'
										+ j
										+ '"><div class="'
										+ i
												.toThemeProperty("jqx-icon-close jqx-file-upload-icon")
										+ '"></div></div>');
								m.append(k);
								o = a('<div class="'
										+ i
												.toThemeProperty("jqx-widget-header jqx-rc-all jqx-file-upload-file-upload")
										+ '" title="'
										+ l
										+ '"><div class="'
										+ i
												.toThemeProperty("jqx-icon-arrow-up jqx-file-upload-icon jqx-file-upload-icon-upload")
										+ '"></div></div>');
								m.append(o);
								n = a('<div class="'
										+ i
												.toThemeProperty("jqx-file-upload-loading-element")
										+ '"></div>');
								m.append(n);
								if (i.rtl) {
									h
						...
						_setMaxWidth : function(c) {
							var f = this;
							var g = c.cancelFile.outerWidth(true)
									+ c.uploadFile.outerWidth(true);
							var b = f._ie7 ? 6 : 0;
							var e = f.host.width()
									- parseInt(f.host.css("padding-left"), 10)
									- parseInt(f.host.css("padding-right"), 10)
									- g - b - 7;
						...
						_addFileHandlers : function(b) {
							...
							if (!c.renderFiles) {
								...
								c.addHandler(b.uploadFile,
										"click.jqxFileUpload" + e, function() {
											if (c.disabled === false) {
												c._uploadFile(b)
											}
										});
						...
						_removeFileRow : function(b) {
							...
							var e = c.element.id;
							if (!c.renderFiles) {
								c.removeHandler(b.uploadFile,
										"mouseenter.jqxFileUpload" + e);
								c.removeHandler(b.uploadFile,
										"mouseleave.jqxFileUpload" + e);
								c.removeHandler(b.uploadFile,
										"click.jqxFileUpload" + e);
								c.removeHandler(b.cancelFile,
										"mouseenter.jqxFileUpload" + e);
								c.removeHandler(b.cancelFile,
										"mouseleave.jqxFileUpload" + e);
								c.removeHandler(b.cancelFile,
						...
						_addHandlers : function() {
							...
							var c = b.element.id;
							if (!b._ieOldWebkit) {
								b.addHandler(b._browseButton,
										"click.jqxFileUpload" + c, function() {
											b.browse()
										})
							}
							b.addHandler(b._uploadButton, "click.jqxFileUpload"
									+ c, function() {
								b.uploadAll()
							});
							b.addHandler(b._cancelButton, "click.jqxFileUpload"
									+ c, function() {
								b.cancelAll()
							});
							b
											...
											function() {
												...
												if (b._iframeInitialized === false) {
													...
													if (b._fileObjectToRemove) {
														b
																._removeSingleFileRow(b._fileObjectToRemove);
														b._fileObjectToRemove = null
													}
													b._uploadQueue.pop();
													if (b._uploadQueue.length > 0) {
														b
																._uploadFile(b._uploadQueue[b._uploadQueue.length - 1])
													}
												}
											})
						},
						_removeHandlers : function(b) {
							var e = this;
							var f = e.element.id;
							e.removeHandler(e._browseButton,
									"click.jqxFileUpload" + f);
							e.removeHandler(e._uploadButton,
									"click.jqxFileUpload" + f);
							e.removeHandler(e._cancelButton,
									"click.jqxFileUpload" + f);
							e.removeHandler(e._uploadIframe,
									"load.jqxFileUpload" + f);
							if (b === true) {
								var c = e._forms[e._forms.length - 1];
								e.removeHandler(c.fileInput,
										"change.jqxFileUpload" + f);
								if (e._ieOldWebkit) {
									e.removeHandler(c.form,
											"mouseenter.jqxFileUpload" + f);
									e.removeHandler(c.form,
											"mouseleave.jqxFileUpload" + f);
									e.removeHandler(c.form,
											"mousedown.jqxFileUpload" + f);
									e.removeHandler(a("body"),
											"mouseup.jqxFileUpload" + f)
								}
							}
						}
					})
