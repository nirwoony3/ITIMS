					...
					a.jqx._jqxTabs.prototype,
					{
						defineInstance : function() {
							var b = {
								...
								_needScroll : true,
								_isAnimated : {},
								_events : [ "created", "selected", "add",
										"removed", "enabled", "disabled",
										"selecting", "unselecting",
										"unselected", "dragStart", "dragEnd",
										"locked", "unlocked", "collapsed",
										"expanded", "tabclick" ],
								_initTabContentList : [],
						...
						createInstance : function() {
							this._IE8 = a.jqx.browser.msie
									&& a.jqx.browser.version < 9;
							a.jqx.aria(this);
							this.element.className += " "
									+ this
											.toThemeProperty("jqx-tabs jqx-widget jqx-widget-content");
							...
							if (this.selectionTracker) {
								this.selectionTracker = this
										._seletionTrackerBrowserCheck()
							}
							if (this._isTouchDevice) {
								this.reorder = false;
								this.keyboardNavigation = false
							}
							this._titleList = this._unorderedListHelper
									.children();
							...
							while (c) {
								...
								if (!this._titleList[c].getAttribute("id")) {
									this._titleList[c].setAttribute("id",
											this.element.id + "Tab" + c)
								}
								this._contentList[c].setAttribute("role",
										"tabpanel")
							}
						...
						_uiRefresh : function(b) {
							this._unorderedListLeftBackup = this._unorderedListHelper
									.css("left");
							if (b) {
								this._render()
							}
							...
							if (this._unorderedListLeftBackup === "auto") {
								this._unorderedListLeftBackup = this
										._getArrowsDisplacement()
							}
							this._unorderedList.style.left = this
									._toPx(this._unorderedListLeftBackup);
							if (this.rtl) {
								if (this.scrollable
										&& this._rightArrow
										&& a(this._rightArrow)
									...
									var c = this._width(this.element)
											- parseInt(
													this
															._width(this._unorderedList)
															+ d
															+ parseInt(
																	this._unorderedListHelper
																			.css("margin-left"),
																	10), 10);
						...
						_addStyles : function() {
							this._unorderedList.className += " "
									+ this
											.toThemeProperty("jqx-tabs-title-container");
							...
							while (c) {
								...
								case "top":
									b += " jqx-rc-t";
									this._removeClass(this._contentList[c],
											this.toThemeProperty("jqx-rc-t"));
									this._contentList[c].className += " "
											+ this.toThemeProperty("jqx-rc-b");
									break;
								case "bottom":
									b += " jqx-rc-b";
									this._removeClass(this._contentList[c],
								...
								d.className = "jqx-reset jqx-disableselect "
										+ this.toThemeProperty(b)
							}
							if (this.selectionTracker) {
								switch (this.position) {
								case "top":
									this._removeClass(this._selectionTracker,
											this.toThemeProperty("jqx-rc-b"));
									this._selectionTracker.className += " "
											+ this.toThemeProperty("jqx-rc-t");
									break;
								case "bottom":
									this._removeClass(this._selectionTracker,
										...
										setTimeout(
												function() {
													...
													var j = new a.Event(
															"loadContent");
													j.owner = this;
													if (f._contentList.length > 0
															&& f._contentList[f.selectedItem]) {
														a(
																f._contentList[f.selectedItem])
																.trigger(j)
													}
						...
						_scrollRight : function(e) {
							...
							var f = parseInt(this._width(this._unorderedList)
									+ parseInt(this._unorderedListHelper
											.css("margin-left"), 10), 10), h = this
									._width(this.element), g, i, b = parseInt(
									this._unorderedListHelper.css("left"), 10), c = this
									._getArrowsDisplacement(), d = 0, j;
							if (this.scrollable) {
							...
							if (this._width(this._headerWrapper) > parseInt(
									this._unorderedListHelper
											.css("margin-left"), 10)
									+ this._width(this._unorderedList)) {
								d = c
							} else {
								if (Math.abs(b) + this.scrollStep < Math.abs(h
										- f)
										+ g + i + c) {
									d = b - this.scrollStep;
									j = b
											...
											+ parseInt(
													a(
															this._titleList[this._selectedItem])
															.position().left,
													10)
								} else {
									d = h - f - (2 * this.arrowButtonSize - c);
									if (d < parseInt(this._unorderedListHelper
											.css("left"), 10) - 4
											&& d > parseInt(
													this._unorderedListHelper
															.css("left"), 10) + 4) {
						...
						_scrollLeft : function(f) {
							this._stop(this._unorderedListHelper);
							this._unlockAnimation("unorderedList");
							var b = parseInt(this._unorderedListHelper
									.css("left"), 10), c = this
									._getArrowsDisplacement(), e = 0, d;
							f = (this.enableScrollAnimation) ? f : 0;
							if (this._width(this._headerWrapper) >= this
									._width(this._unorderedList)) {
								e = c
							} else {
								if (b + this.scrollStep < c) {
									...
									e = c;
									if (e < parseInt(this._unorderedListHelper
											.css("left"), 10) - 4
											&& e > parseInt(
													this._unorderedListHelper
															.css("left"), 10) + 4) {
						...
						_addKeyboardHandlers : function() {
							...
							if (this.keyboardNavigation) {
								this.addHandler(this.host, "keydown", function(
										e) {
						...
						_addScrollHandlers : function() {
							var b = this;
							this.addHandler(this._leftArrow, "mousedown",
									function() {
										b._startScrollRepeat(true,
												b.scrollAnimationDuration)
									});
							this.addHandler(this._rightArrow, "mousedown",
									function() {
										b._startScrollRepeat(false,
												b.scrollAnimationDuration)
									});
							this.addHandler(this._rightArrow, "mouseleave",
									function() {
										clearTimeout(b._scrollTimeout)
									});
							this.addHandler(this._leftArrow, "mouseleave",
									function() {
										clearTimeout(b._scrollTimeout)
									});
							this.addHandler(a(document), "mouseup.tab"
									+ this.element.id,
									this._mouseUpScrollDocumentHandler, this);
							this
									.addHandler(
											a(document),
											"mouseleave.tab" + this.element.id,
											this._mouseLeaveScrollDocumentHandler,
											this)
						},
						...
						_addReorderHandlers : function() {
							var b = this;
							b.addHandler(a(document), "mousemove.tab"
									+ b.element.id, b._moveElement, b);
							b.addHandler(a(document), "mouseup.tab"
									+ b.element.id,
									b._mouseUpDragDocumentHandler, b)
						},
						...
						_getFocusedItem : function(c) {
							...
							while (d) {
								d--;
								var b = this._titleList[d], g = this
										._outerWidth(b, true), f = parseInt(
										a(b).offset().left, 10), e = f;
								if ((e <= c && e + g >= c)
										&& (b !== this._capturedElement)
										&& (!this._titleList[d].locked)
										&& (this._titleList[d].disabled !== true)) {
									return d
								}
							}
							return -1
						...
						_reorderItems : function(c, b) {
							...
							if (b < c) {
								if (this._titleList[c + 1]) {
									this._unorderedList.insertBefore(d,
											this._titleList[c + 1])
								} else {
						...
						_moveElement : function(d) {
							...
							if (c._tabCaptured) {
								...
								if (!c._dragStarted) {
									var b = -parseInt(c._unorderedListHelper
											.css("left"), 10);
									if (d.clientX + b > c._startX + 3
											|| d.clientX + b < c._startX - 3) {
						...
						_performDrag : function(d) {
							var c = this.getZoomFactor(), b = -parseInt(
									this._unorderedListHelper.css("left"), 10);
							this._capturedElement.style.left = this._toPx(b
									+ d.clientX / c - this._startX / c);
						...
						_prepareTabForDragging : function() {
							...
							this.selectedItem = this
									._indexOf(this._capturedElement);
							switch (this.position) {
							case "top":
								this._capturedElement.style.bottom = this
										._toPx(a(this._capturedElement).css(
												"top"));
								break;
							case "bottom":
								this._capturedElement.style.top = this._toPx(a(
						...
						_dragScroll : function(d) {
							...
							if (d.clientX <= e.offset().left) {
								...
								this._capturedElement.style.left = parseInt(a(
										this._capturedElement).css("left"), 10)
										+ this._lastUnorderedListPosition - b
							} else {
								if (d.clientX > e.offset().left
										+ c._width(this._headerWrapper)) {
									this
											._scrollRight(this.scrollAnimationDuration);
									this._capturedElement.style.left = parseInt(
											a(this._capturedElement)
													.css("left"), 10)
											+ this._lastUnorderedListPosition
											- b
								} else {
						...
						_captureElement : function(d, c) {
							if (!this._tabCaptured
									&& !this._titleList[c].locked
									&& this._titleList[c].disabled !== true
						...
						collapse : function() {
							...
							if (this.position === "top") {
								c._headerWrapper.className += " "
										+ this
												.toThemeProperty("jqx-tabs-header-collapsed");
								c.element.className += " "
										+ this
												.toThemeProperty("jqx-tabs-collapsed")
							} else {
								c._headerWrapper.className += " "
										+ this
												.toThemeProperty("jqx-tabs-header-collapsed-bottom");
								c.element.className += " "
										+ this
												.toThemeProperty("jqx-tabs-collapsed-bottom")
							}
						},
						expand : function() {
							var b = this._selectedItem, c = this;
							this.isCollapsed = false;
							this._select(b, c.contentTransitionDuration, null,
									false, true);
							if (c.height !== "auto") {
						...
						_addSelectHandler : function(b) {
							var c = this;
							this.addHandler(this._titleList[b], "selectstart",
									function() {
										return false
									});
							this.addHandler(this._titleList[b],
									this.toggleMode, (function(d) {
										return function() {
											c._raiseEvent("15", {
												item : d
											});
						...
						_addDragDropHandlers : function(b) {
							var c = this;
							this.addHandler(this._titleList[b], "mousedown",
									function(d) {
										c._captureElement(d, b);
										return false
									});
							this.addHandler(this._titleList[b], "mouseup",
									function(d) {
											...
											function() {
												b
														._removeClass(
																this,
																b
																		.toThemeProperty("jqx-tabs-title-hover-top jqx-tabs-title-hover-bottom"))
											})
						},
						...
						_removeEventHandlers : function() {
							...
							c.removeHandler(a(document), "mousemove.tab"
									+ c.element.id, c._moveElement);
							c.removeHandler(a(document), "mouseup.tab"
									+ c.element.id,
									c._mouseUpScrollDocumentHandler);
							c.removeHandler(a(document), "mouseup.tab"
									+ c.element.id,
									c._mouseUpDragDocumentHandler);
							...
							if (this.selectionTracker && this._selectionTracker) {
								...
								if (b === undefined) {
									...
									if (!isNaN(parseInt(
											this._unorderedListHelper
													.css("left"), 10))) {
										i += parseInt(this._unorderedListHelper
												.css("left"), 10)
									}
									if (!isNaN(parseInt(
											this._unorderedListHelper
									...
									if (!isNaN(parseInt(o.css("margin-left"),
											10))) {
										i += parseInt(o.css("margin-left"), 10)
									}
									if (!isNaN(parseInt(o.css("margin-right"),
											10))) {
									}
								} else {
									i = b
								...
								var e = 0;
								if (this.position === "top") {
									g = this._height(h._headerWrapper)
											- m.offsetHeight;
									if (!this.autoHeight) {
								...
								var l = parseInt(o.css("padding-left"), 10)
										+ parseInt(o.css("padding-right"), 10);
								var f = this.position === "top" ? 0 : 1;
								var k = parseInt(a(this._headerWrapper).css(
										"padding-top"), 10);
								var j = parseInt(o.css("padding-top"), 10)
								...
								h._selectionTrackerHelper
										.animate(
												...
												function() {
													h
															._unlockAnimation("selectionTracker");
						...
						_switchTabs : function(b, d) {
							if (b !== d && !this._activeAnimation()
								...
								this._select(b, c.contentTransitionDuration,
										null, true);
								return true
							}
							return false
						...
						_validateProperties : function() {
							try {
								if (this.scrollAnimationDuration < 0
										|| isNaN(this.scrollAnimationDuration)) {
									throw new Error(
								...
								if (parseInt(this.width, 10) < 0
										&& this.width !== "auto") {
									throw new Error(
											this._invalidArgumentExceptions.invalidWidth)
								}
								if (parseInt(this.height, 10) < 0
										&& this.height !== "auto") {
									throw new Error(
											this._invalidArgumentExceptions.invalidHeight)
								}
								if (this.animationType !== "none"
										&& this.animationType !== "fade") {
									throw new Error(
											this._invalidArgumentExceptions.invalidAnimationType)
								}
								if (this.contentTransitionDuration < 0
										|| isNaN(this.contentTransitionDuration)) {
									throw new Error(
											this._invalidArgumentExceptions.invalidcontentTransitionDuration)
								}
								if (this.toggleMode !== "click"
										&& this.toggleMode !== "dblclick"
										&& this.toggleMode !== "mouseenter"
										&& this.toggleMode !== "none") {
									throw new Error(
											this._invalidArgumentExceptions.invalidToggleMode)
								}
								if (this.position !== "top"
										&& this.position !== "bottom") {
									throw new Error(
											this._invalidArgumentExceptions.invalidPosition)
								}
								if (this.scrollPosition !== "left"
										&& this.scrollPosition !== "right"
										&& this.scrollPosition !== "both") {
									throw new Error(
											this._invalidArgumentExceptions.invalidScrollPosition)
								}
								if (this.scrollStep < 0
										|| isNaN(this.scrollStep)) {
									throw new Error(
											this._invalidArgumentExceptions.invalidScrollStep)
								}
								if (this._titleList.length !== this._contentList.length
										|| this._titleList.length === 0) {
									throw new Error(
											this._invalidArgumentExceptions.invalidStructure)
								}
								if (this.arrowButtonSize < 0
										|| isNaN(this.arrowButtonSize)) {
									throw new Error(
											this._invalidArgumentExceptions.invalidArrowSize)
								}
								if (this.closeButtonSize < 0
										|| isNaN(this.closeButtonSize)) {
									throw new Error(
											this._invalidArgumentExceptions.invalidCloseSize)
								}
							} catch (b) {
								try {
									console.log(b)
						...
						_setSize : function() {
							...
							if (b._totalItemsWidth > b.element.offsetWidth) {
								b._unorderedList.style.width = b
										._toPx(b._totalItemsWidth)
							} else {
								b._unorderedList.style.width = b.element.offsetWidth
										- 2 + "px"
							}
							b._fitToSize()
						},
						_addArrows : function() {
							...
							this._leftArrow.innerHTML = '<span style="display: block; width: 16px; height: 16px;" class="'
									+ this
											.toThemeProperty("jqx-tabs-arrow-left")
									+ '"></span>';
							this._leftArrow.className = this
									.toThemeProperty("jqx-tabs-arrow-background jqx-widget-header");
							this._leftArrow.style.zIndex = 30;
							this._leftArrow.style.display = "none";
							this._leftArrow.style.width = this
									._toPx(this.arrowButtonSize);
							this._leftArrow.style.height = "100%";
							this._rightArrow = document.createElement("div");
							this._rightArrow.innerHTML = '<span style="display: block; width: 16px; height: 16px;" class="'
									+ this
											.toThemeProperty("jqx-tabs-arrow-right")
									+ '"></span>';
							this._rightArrow.className = this
									.toThemeProperty("jqx-tabs-arrow-background jqx-widget-header");
							this._rightArrow.style.zIndex = 30;
							this._rightArrow.style.display = "none";
							this._rightArrow.style.width = this
									._toPx(this.arrowButtonSize);
						...
						_calculateTitlesSize : function() {
							...
							while (h) {
								...
								if (this._measureItem) {
									...
									this._measureItem.html(this._titleList[h]
											.html());
									j.style.width = g._toPx(g
											._width(this._measureItem))
								}
								...
								if (c !== undefined && c !== null) {
									...
									if (this.showCloseButtons
											&& (this.canCloseAllTabs || this
													._tabsWithVisibleCloseButtons() > 1)) {
										d = false;
										if (this.hiddenCloseButtons) {
											if (this.hiddenCloseButtons[h] === 1) {
												f(b, false);
						...
						_reorderHeaderElements : function() {
							...
							if (this.scrollable) {
								...
								var c = this.theme
										&& this.theme.indexOf("ui-") !== -1 ? 3
										: 0;
								if (c > 0) {
									this._rightArrow.className += " "
											+ this.toThemeProperty("jqx-rc-r");
									this._leftArrow.className += " "
											+ this.toThemeProperty("jqx-rc-l")
								}
								...
								case "both":
									...
									break;
								case "left":
									this._rightArrow.style.left = this
											._toPx(this.arrowButtonSize);
									this._leftArrow.style.left = "0px";
									break;
								case "right":
									this._rightArrow.style.right = this
											._toPx(-c);
									this._leftArrow.style.right = this
											._toPx(parseInt(
													this.arrowButtonSize, 10)
													- c);
									break
								}
							}
						...
						_positionArrows : function(b) {
							if (b >= this._headerWrapper.offsetWidth
									&& this.scrollable) {
						...
						_performHeaderLayout : function() {
							...
							if (this.headerHeight !== null
								...
								this._headerWrapper.style.height = this
										._toPx(this.headerHeight);
								this._unorderedList.style.height = this
										._toPx(this.headerHeight)
							}
						...
						_verticalAlignElements : function() {
							...
							while (j) {
								j--;
								var n = this._titleList[j], p = a(n), b = p
										.children()[0], m = this._closeButtonList[j], k = parseInt(
										p.css("padding-top"), 10);
								if (!k) {
									k = 0
								}
								if (this.autoHeight) {
									var c = parseInt(p.css("padding-top"), 10), o = parseInt(
											p.css("padding-bottom"), 10), i = p
											.css("border-top-width"), f = p
									...
									n.style.height = this._toPx(this
											._outerHeight(this._unorderedList,
													true)
											- (c + o + i + f))
								} else {
									if (this.position === "top") {
										var h = this
												._height(this._unorderedList)
												- parseInt(this._outerHeight(n,
														true), 10);
										if (parseInt(p.css("margin-top"), 10) !== h
												&& h !== 0) {
							...
							if (this.scrollable) {
								var d = (parseInt(
										this._headerWrapper.offsetHeight, 10) - this.arrowButtonSize) / 2;
								a(this._rightArrow).children()[0].style.marginTop = this
										._toPx(d);
								this._rightArrow.style.height = "100%";
								a(this._leftArrow).children()[0].style.marginTop = this
										._toPx(d);
								this._leftArrow.style.height = "100%"
							}
						},
						...
						_fitToSize : function() {
							...
							if (e) {
								...
								b = this.element.offsetHeight
										- this._headerWrapper.offsetHeight;
								this._contentWrapper.style.height = b + "px"
							} else {
								if (this.height !== "auto") {
									d.element.style.height = d._toPx(d.height);
									b = this._height(d.element)
											- this._headerWrapper.offsetHeight;
									this._contentWrapper.style.height = d
											._toPx(b)
								} else {
									this._contentWrapper.style.height = "auto"
								}
						...
						_maxHeightTab : function() {
							...
							while (c) {
								c--;
								if (d < this._outerHeight(this._titleList[c],
										true)) {
									b = c
								}
							}
						...
						_addSelectionTracker : function() {
							...
							this._moveSelectionTrackerContainer = document
									.createElement("div");
							this._moveSelectionTrackerContainer.className = this
									.toThemeProperty("jqx-tabs-selection-tracker-container");
							this._selectionTracker = document
									.createElement("div");
							this._selectionTracker.className = this
									.toThemeProperty("jqx-tabs-selection-tracker-"
											+ this.position);
							...
							this._moveSelectionTrackerContainer
									.appendChild(this._selectionTracker);
							this._headerWrapper
									.appendChild(this._moveSelectionTrackerContainer);
						...
						_addContentWrapper : function() {
							...
							if (b) {
								this._contentWrapper = document
										.createElement("div");
								this._contentWrapper.className = this
										.toThemeProperty("jqx-tabs-content jqx-widget-content");
								this._contentWrapper.style["float"] = e
							}
							var d = this.length();
							while (d) {
								d--;
								this._contentList[d].className += " "
										+ this
												.toThemeProperty("jqx-tabs-content-element")
							}
							if (b) {
								if (this.position === "top") {
									this.element
											.appendChild(this._contentWrapper)
								} else {
								...
								for (var c = 0; c < this._contentList.length; c++) {
									this._contentWrapper
											.appendChild(this._contentList[c])
								}
							}
							if (this.roundedCorners) {
								if (this.position === "top") {
									this._contentWrapper.className += " "
											+ this.toThemeProperty("jqx-rc-b")
								} else {
									this._contentWrapper.className += " "
											+ this.toThemeProperty("jqx-rc-t")
						...
						_addHeaderWrappers : function() {
							...
							if (this.position === "top") {
								this.element.insertBefore(this._headerWrapper,
										this.element.firstChild)
							} else {
								this.element.appendChild(this._headerWrapper)
							}
							this._headerWrapper
									.appendChild(this._unorderedList);
							...
							this._headerWrapper.className = this
									.toThemeProperty(b);
							while (d) {
								d--;
						...
						_addCloseButton : function(c, e) {
							...
							b.className = this
									.toThemeProperty("jqx-tabs-close-button");
								...
								if (this.showCloseButtons) {
									...
									this
											._removeClass(
													c,
													this
															.toThemeProperty("jqx-tabs-close-button-selected"))
								}
						...
						_select : function(h, e, l, b, c) {
							if (!this._tabCaptured) {
								...
								var k = a(g._titleList[h]), d = g._titleList[h]
										.getAttribute("id"), j = a(g._contentList[h]);
								...
								case "fade":
									...
									j
											.fadeIn({
												...
												complete : function() {
													g
															._unlockAnimation("contentListSelect");
													a.jqx.aria(k,
															"aria-selected",
															true);
													a.jqx.aria(j,
									...
									if (!this.selectionTracker) {
										g
												._removeClass(
														h,
														g
																.toThemeProperty("jqx-tabs-title-selected jqx-fill-state-pressed"))
									}
								}
							}
						},
						...
						removeAt : function(b) {
							if (this._isValidIndex(b)
									&& (this.canCloseAllTabs || this.length() > 1)) {
								this._removeHoverStates();
								var d = this, c = d._outerWidth(
										this._titleList[b], true), g = this
										.getTitleAt(b);
								this._unorderedList.style.width = d._toPx(d
										._width(this._unorderedList)
										- c);
								...
								if (this.selectedItem > 0) {
									...
									if (this.selectedItem >= b) {
										f = this
												._getPreviousIndex(this.selectedItem);
										this.select(f)
									} else {
								...
								if (parseInt(this._unorderedListHelper
										.css("left"), 10) > this
										._getArrowsDisplacement()) {
									this._unorderedList.style.left = d
											._toPx(this
													._getArrowsDisplacement())
								}
								if (d._width(this._unorderedList) <= d
										._width(this._headerWrapper)) {
									var e = (this.enableScrollAnimation) ? this.scrollAnimationDuration
											: 0;
									this._lockAnimation("unorderedList");
									this._unorderedListHelper.animate({
										left : 0
						...
						disableAt : function(b) {
							...
							if (!d.disabled || d.disabled === undefined) {
								...
								d.className += " "
										+ this
												.toThemeProperty("jqx-tabs-title-disable jqx-fill-state-disabled");
								this._raiseEvent(5, {
									item : b
								})
							}
						...
						addAt : function(d, g, e) {
							if (d >= 0 && d <= this.length()) {
								...
								b.innerHTML = g;
								b.className = this
										.toThemeProperty("jqx-tabs-title jqx-item");
								var f = document.createElement("div");
								f.innerHTML = e;
								f.className = this
										.toThemeProperty("jqx-tabs-content-element");
								if (this.position === "bottom") {
									b.className += " "
											+ this
													.toThemeProperty("jqx-tabs-title-bottom")
								}
								var c = false;
								if (this._titleList.length === 0) {
									...
									if (d < this.length() && d >= 0) {
										this._unorderedList.insertBefore(b,
												this._titleList[d])
									} else {
										this._unorderedList.appendChild(b)
									}
						...
						select : function(b) {
							...
							var d = b >= 0 && b < this._titleList.length ? this._titleList[b]
									.getAttribute("canselect")
									: true;
							if (d === undefined || d === null || d === "true"
									|| d === true) {
								if (b !== this._selectedItem
										&& this._isValidIndex(b)) {
									if (!this._activeAnimation()
											&& !this._titleList[b].disabled) {
										var c = this._switchTabs(b,
												this._selectedItem);
										if (c) {
						...
						lockAt : function(b) {
							if (this._isValidIndex(b)
									&& (!this._titleList[b].locked || this._titleList[b].locked === undefined)) {
						...
						ensureVisible : function(e) {
							...
							var l = parseInt(a(j).position().left, 10)
									+ parseInt(this._unorderedListHelper
											.css("margin-left"), 10);
							var g = parseInt(this._unorderedListHelper
									.css("left"), 10);
							...
							if (l < -i) {
								...
								if (l + f > b - this._getArrowsDisplacement()) {
									h = -l
											+ k
											- f
											- ((this.scrollable) ? (2 * this.arrowButtonSize - this
													._getArrowsDisplacement())
													: 0);
							...
							this._moveSelectionTrack(e,
									this.selectionTrackerAnimationDuration, c);
							return true
						},
						isVisibleAt : function(d) {
							...
							var j = parseInt(a(h).position().left, 10)
									+ parseInt(c._unorderedListHelper
											.css("margin-left"), 10);
							var f = parseInt(
									c._unorderedListHelper.css("left"), 10);
						...
						propertyChangedHandler : function(b, c, e, d) {
							if (b.batchUpdate && b.batchUpdate.width
						...
						_width : function(e) {
							var b = a(e), g = b.css("border-left-width"), c = b
									.css("border-right-width"), d = parseInt(b
									.css("padding-left"), 10), h = parseInt(b
						...
						_outerWidth : function(c, g) {
							var f = c.offsetWidth;
							if (g) {
								var b = a(c), d = parseInt(
										b.css("margin-left"), 10), e = parseInt(
						...
						_height : function(e) {
							var c = a(e), h = c.css("border-top-width"), d = c
									.css("border-bottom-width"), f = parseInt(c
									.css("padding-top"), 10), g = parseInt(c
						...
						_outerHeight : function(e, g) {
							...
							if (g) {
								var b = a(e), c = parseInt(b.css("margin-top"),
										10), d = parseInt(b
